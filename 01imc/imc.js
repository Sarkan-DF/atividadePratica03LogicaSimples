...
const peso = Number.parseFloat(prompt("Digite seu peso: "))
const altura = Number.parseFloat(prompt("Digite sua altura: "))
...
document.write(`${mensagem}, seu imc é: ${imc.toFixed(2)}`)